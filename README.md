...
zoomToData                                      | FitBounds options         | false                               | Zooms the map to given data & draw data. The options can include also paddingInMeters, minZoom, dataIdxs (number[]) & draw (boolean) as an options.
